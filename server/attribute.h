...
public:
	...
	double			periodic_counter;	// Number of periodic events sent so far
	double			archive_periodic_counter;	// Number of periodic events sent so far
	LastAttrValue		prev_change_event;		// Last change attribute
	LastAttrValue		prev_quality_event;		// Last quality attribute
	LastAttrValue		prev_periodic_event;		// Last periodic attribute
