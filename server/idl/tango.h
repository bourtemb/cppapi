...
#define __Tango_mDevice__4__
  ...
  public:
    ...
    AttributeValueList_4* read_attributes_4(const DevVarStringArray& names, DevSource source);
    void write_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident);
    void set_attribute_config_4(const AttributeConfigList_3& new_conf, const ClntIdent& cl_ident);
    AttributeValueList_4* write_read_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident);
  ...
  public:
    ...
    virtual AttributeValueList_4* read_attributes_4(const DevVarStringArray& names, DevSource source) = 0;
    virtual void write_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident) = 0;
    virtual void set_attribute_config_4(const AttributeConfigList_3& new_conf, const ClntIdent& cl_ident) = 0;
    virtual AttributeValueList_4* write_read_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident) = 0;
