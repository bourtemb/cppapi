...
DbDatum Database::get_device_alias(string  &dev)
{
	...
	Any_var received = command_inout("DbGetAttributeAliasList",send);
	const char *attr_alias;
	received >>= attr_alias;
...
//-----------------------------------------------------------------------------
//
// Database::get_attribute_alias() - public method to get attribute alias from
//                               the Database
//
//-----------------------------------------------------------------------------
