...
//
	...
	{
		// force library defaults (even if user defaults defined)
		standard_unit = AlrmValueNotSpec;
	}
...
//
// Get the vector of user default properties to store the AlrmValueNotSpec in
