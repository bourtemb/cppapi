...
Tango::AttributeValue_4::operator>>= (cdrStream &_n) const
{
  ...
  (const AttributeDim&) w_dim >>= _n;
  (const DevErrorList&) err_list >>= _n;
  (const DevVarEncodedArray&) enc_value >>= _n;
...
Tango::AttributeValue_4::operator<<= (cdrStream &_n)
{
  ...
  (AttributeDim&)w_dim <<= _n;
  (DevErrorList&)err_list <<= _n;
  (DevVarEncodedArray&)enc_value <<= _n;
...
// Proxy call descriptor class. Mangled signature:
//  _cTango_mAttributeValueList__4_i_cTango_mDevVarStringArray_i_cTango_mDevSource_e_cTango_mDevFailed
...
_0RL_lcfn_6fe2f94a21a10053_c3000000(omniCallDescriptor* cd, omniServant* svnt)
{
  ...
  Tango::_impl_Device_4* impl = (Tango::_impl_Device_4*) svnt->_ptrToInterface(Tango::Device_4::_PD_repoId);
#ifdef HAS_Cplusplus_catch_exception_by_base
  tcd->result = impl->read_attributes_4(*tcd->arg_0, tcd->arg_1);
#else
  if (!cd->is_upcall())
    tcd->result = impl->read_attributes_4(*tcd->arg_0, tcd->arg_1);
  else {
...
Tango::AttributeValueList_4* Tango::_objref_Device_4::read_attributes_4(const DevVarStringArray& names, DevSource source)
{
...
// Proxy call descriptor class. Mangled signature:
//  void_i_cTango_mAttributeValueList_i_cTango_mClntIdent_e_cTango_mDevFailed_e_cTango_mMultiDevFailed
...
void Tango::_objref_Device_4::write_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident)
{
...
// Proxy call descriptor class. Mangled signature:
//  _cTango_mAttributeValueList__4_i_cTango_mAttributeValueList_i_cTango_mClntIdent_e_cTango_mDevFailed_e_cTango_mMultiDevFailed
...
Tango::AttributeValueList_4* Tango::_objref_Device_4::write_read_attributes_4(const AttributeValueList& values, const ClntIdent& cl_ident)
{
