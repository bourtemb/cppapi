...
static CORBA::TypeCode_ptr _0RL_tc_Tango_mAttrDataFormat = CORBA::TypeCode::PR_enum_tc("IDL:Tango/AttrDataFormat:1.0", "AttrDataFormat", _0RL_enumMember_Tango_mAttrDataFormat, 3, &_0RL_tcTrack);
#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Tango { 
...
static CORBA::PR_structMember _0RL_structmember_Tango_mAttributeValue__4[] = {
  ...
  {"w_dim", _0RL_tc_Tango_mAttributeDim},
  {"err_list", _0RL_tc_Tango_mDevErrorList},
  {"enc_value", _0RL_tc_Tango_mDevVarEncodedArray}
};
