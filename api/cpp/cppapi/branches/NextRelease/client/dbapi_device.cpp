...
DbDevice::DbDevice(string &dev_name, Database *dev_dbase):ext(NULL)
{
	name = dev_name;
	dbase = dev_dbase;
	ext_dbase = true;
...
DbDevice::DbDevice(string &dev_name):ext(NULL)
{
	name = dev_name;
...
DbDevice::DbDevice(string &dev_name,string &host,string &port_str):ext(NULL)
{
	name = dev_name;
