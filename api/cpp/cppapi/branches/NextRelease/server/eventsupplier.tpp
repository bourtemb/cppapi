////////////////////////////////////////////////////////////////////////////////
//
//  file       eventsupplier.tpp
//
//              C++ file for EventSupplier class template methods definition
//
// 		author(s) : E. Taurel
//
// 		original : 11 July 2011
//
// Copyright (C) :      2011
...
#ifndef _EVENT_SUPPLIER_API_TPP
#define _EVENT_SUPPLIER_API_TPP
...
template <typename T>
void EventSupplier::detect_and_push_change_event(DeviceImpl *device_impl,struct AttributeData<T> &attr_value,
...
template <typename T>
void EventSupplier::detect_and_push_archive_event(DeviceImpl *device_impl,AttributeData<T> &attr_value,
...
template <typename T>
void EventSupplier::detect_and_push_periodic_event(DeviceImpl *device_impl,struct AttributeData<T> &attr_value,
                    Attribute &attr,string &attr_name,DevFailed *except,struct timeval *time_bef_attr)
{
	string event, domain_name;
	double now_ms, ms_since_last_periodic;
...
template <typename T>
bool EventSupplier::detect_change(Attribute &attr,struct AttributeData<T> &attr_value,bool archive,
...
//
            ...
            if ((attr_value.attr_val_4 != NULL) && (attr_value.attr_val_4->value._d() == ATT_ENCODED))
            {
                ...
                Tango::DevVarEncodedArray &un_seq = attr_value.attr_val_4->value.encoded_att_value();
...
template <typename T>
void EventSupplier::push_att_conf_events(DeviceImpl *device_impl,T &attr_conf,DevFailed *except,string &attr_name)
{
    string event, domain_name;
    ...
    struct AttributeData<T> ad;
    ::memset(&ad,0,sizeof(ad));
    ad.attr_misc = &attr_conf;
...
template <typename T>
void EventSupplier::push_event(DeviceImpl *device_impl,string event_type,
            ...
            struct AttributeData<T> &attr_value,string &attr_name,DevFailed *except)
{
	...
	if (except == NULL)
	{
	    if (attr_value.attr_misc != NULL)
            struct_event.remainder_of_body <<= (*attr_value.attr_misc);
		else if (attr_value.attr_val != NULL)
