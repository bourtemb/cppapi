...
template <typename T>
void EventSupplier::detect_and_push_events(DeviceImpl *device_impl,T &attr_value,DevFailed *except,string &attr_name)
{
...
template <typename T>
void EventSupplier::detect_and_push_change_event(DeviceImpl *device_impl,T &attr_value,
                     Attribute &attr,string &attr_name,DevFailed *except)
{
    string event, domain_name;
...
template <typename T>
void EventSupplier::detect_and_push_archive_event(DeviceImpl *device_impl,T &attr_value,
                      Attribute &attr,string &attr_name,DevFailed *except)
{
    string event, domain_name;
    double delta_change_rel = 0.0;
...
template <typename T>
void EventSupplier::detect_and_push_quality_change_event(DeviceImpl *device_impl,T &attr_value,
                      Attribute &attr,string &attr_name,DevFailed *except)
{
...
template <typename T>
void EventSupplier::detect_and_push_periodic_event(DeviceImpl *device_impl,T &attr_value,
                    Attribute &attr,string &attr_name,DevFailed *except)
{
    string event, domain_name;
    double now_ms, ms_since_last_periodic;
...
template <typename T>
bool EventSupplier::detect_change(Attribute &attr,T &curr_attr_value,bool archive,
...
void EventSupplier::push_event(DeviceImpl *device_impl,string event_type,
            ...
            T &attr_value,string &attr_name,DevFailed *except)
{
